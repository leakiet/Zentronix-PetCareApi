...
public class ClinicInfoController {
  ...
  public ResponseEntity<List<ClinicInfoResponse>> searchClinicInfos(
    ...
    try {
      List<ClinicInfoResponse> responses = clinicInfoService.searchClinicInfos(specialization, location);
  ...
  public ResponseEntity<List<User>> getAvailableVets(
    ...
    try {
      ...
      List<ClinicInfoResponse> clinicInfos = clinicInfoService.searchClinicInfos(specialization, location);
